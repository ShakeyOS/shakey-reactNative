...
# Open webpage
echo "\033[1mOpening webpage at http://localhost11:5173...\033[0m"
...
# Show options for React Native and Flutter apps
echo "\033[1m--- Additional Options ---\033[0m"

# React Native instructions
echo "\033[1;32mTo start the React Native app:\033[0m"
echo "\033[1;34m  cd path-to-react-native-app && npx react-native start\033[0m"

# Flutter instructions
echo "\033[1;32mTo start the Flutter app:\033[0m"
echo "\033[1;34m  cd path-to-flutter-app && flutter run\033[0m"

# Reminder to replace paths
echo "\033[1;33mNote: Replace 'path-to-react-native-app' and 'path-to-flutter-app' with the actual paths to your projects.\033[0m"
